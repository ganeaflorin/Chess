...
public class MainFrame extends JFrame {
    ...
    private CoordinatesPanel coordinates = new CoordinatesPanel();
...
//        game.add(coordinates.getLetters(), BorderLayout.SOUTH);
//        game.add(coordinates.getDigits(), BorderLayout.WEST);
